...
const getAllCandidates = async () => {
  if (WALLET_CONNECTED != "") {
      ...
      p3.innerHTML = "Please wait, fetching all the candidates from the smart contract...";
      ...
      // Iterate over the candidates and add rows to the table
      for (let i = 0; i < candidates.length; i++) {
          // Create a new row
          var row = tableBody.insertRow();

          // Create cells for index, name, and vote count
          var indexCell = row.insertCell(0);
          var nameCell = row.insertCell(1);
          var voteCountCell = row.insertCell(2);

          // Fill the cells with the candidate data
          indexCell.innerHTML = i;  // Candidate index
          nameCell.innerHTML = candidates[i].name;  // Candidate name
          voteCountCell.innerHTML = candidates[i].voteCount;  // Candidate vote count
      }
