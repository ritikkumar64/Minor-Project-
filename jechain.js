...
// const ritik = ec.genKeyPair();

// // Create a transaction
// const transaction = new Transaction(holderKeyPair.getPublic("hex"), ritik.getPublic("hex"), 100, 10);
...
// console.log("Miner balance:", JeChain.getBalance(ritik.getPublic("hex")));

JeChain.addBlock(new Block(Date.now().toString(), ["Helo" , "Block"]));
JeChain.addBlock(new Block(Date.now().toString(), ["block" , "2"]));
